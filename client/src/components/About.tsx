        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-300">
                        Custom online stores and payment integrations
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="prose prose-invert max-w-none">
                <div className="text-sm sm:text-base lg:text-lg text-gray-300 leading-relaxed mb-6 sm:mb-8">
